...
MODEL_REGISTRY = {
    ...
    'tfn_timeseries_regressor': {
        'class': TFNTimeSeriesRegressor,
        'task_type': 'time_series',
        'evolution_types': ['cnn', 'pde'],
        'components': ['field_projection', 'field_evolution', 'field_sampling'],
        'required_params': ['input_dim', 'embed_dim', 'output_len', 'kernel_type', 'evolution_type'],
        'optional_params': ['num_layers', 'grid_size', 'time_steps', 'dropout', 'use_global_pooling'],
        'defaults': {
            'num_layers': 2,
            'kernel_type': 'rbf',
            'evolution_type': 'cnn',
    ...
    'tfn_multistep_regressor': {
        'class': TFNMultiStepRegressor,
        'task_type': 'time_series',
        'evolution_types': ['cnn', 'pde'],
        'components': ['field_projection', 'field_evolution', 'field_sampling'],
        'required_params': ['input_dim', 'embed_dim', 'output_len', 'kernel_type', 'evolution_type'],
    ...
    'tfn_sequence_regressor': {
        'class': TFNSequenceRegressor,
        'task_type': 'regression',
        'evolution_types': ['cnn', 'pde'],
        'components': ['field_projection', 'field_evolution', 'field_sampling'],
        'required_params': ['input_dim', 'embed_dim', 'output_dim', 'kernel_type', 'evolution_type'],
    ...
    'enhanced_tfn_classifier': {
        ...
        'required_params': ['vocab_size', 'embed_dim', 'num_classes', 'kernel_type', 'interference_type', 'propagator_type', 'operator_type'],
