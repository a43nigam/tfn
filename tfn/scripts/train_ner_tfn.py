...
import tfn.datasets.ner_loader as nl                          # load_conll2003
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--tfn_type", type=str, choices=["1d", "2d"], default="1d",
                   help="Use 1d or 2d TFN encoder")
...
def main():
    ...
    if args.tfn_type == "1d":
        model = TFNTagger(vocab_size, num_tags, args.embed_dim, args.num_layers,
                          args.grid_size, args.evo_steps).to(device)
    else:
